...
class NEMA_NU2_2007:
    ...
    def analyse_data(self):
        ...
        self.Scatter.generate_report(file_name = 'Results/NEMA_NU2_Scatter', system_details = ['Siemens','Epworth','Tested: 28/05/2020'], captions = ['Count rate as a function of activity concentration.','Scatter fraction as a function of activity concentration with the system scatter fraction plotted in red for comparison.'])
        ...
        print('     |-------------------------------------------------------------')
        #Calculate the scatter properties.
        self.accuracy                           = Accuracy(self.accuracy_dir)
        self.accuracy.analyse_data()
        self.accuracy.generate_report(file_name = 'Results/NEMA_NU2_Accuracy', system_details = ['Siemens','Epworth','Tested: 28/05/2020'], captions = ['Dead time losses of the system as a function of effective activity concentration.'], delete_tex_files = True)
